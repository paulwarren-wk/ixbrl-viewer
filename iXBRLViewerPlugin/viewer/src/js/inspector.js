...
export class Inspector {
    ...
    _populateFileSummary(summaryDom) {
        ...
        insertFileSummary(schema, ".inline-docs");
        insertFileSummary(presLinkbase, ".inline-docs");
        insertFileSummary(calcLinkbase, ".inline-docs");
        insertFileSummary(defLinkbase, ".inline-docs");
        insertFileSummary(labelLinkbase, ".inline-docs");
        insertFileSummary(refLinkbase, ".inline-docs");
        insertFileSummary(unrecognizedLinkbase, ".inline-docs");
        if (visibleItems == 0) {
